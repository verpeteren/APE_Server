...
MOZ_BUILD_ROOT             = /home/para/dev/sociammo/APE_Server/deps/js/src
...
OS_CXXFLAGS	= $(OS_CPPFLAGS) -fno-rtti -fno-exceptions -Wall -Wpointer-arith -Woverloaded-virtual -Wsynth -Wno-ctor-dtor-privacy -Wno-non-virtual-dtor -Wcast-align -Wno-invalid-offsetof -Wno-variadic-macros -pedantic -Wno-long-long -fno-strict-aliasing -pthread -pipe
OS_LDFLAGS	= -lpthread 
...
CC_VERSION	= gcc version 4.3.5 (Debian 4.3.5-1) 
CXX_VERSION	= gcc version 4.4.4 (Debian 4.4.4-6) 
...
OS_TARGET=Linux
OS_ARCH=Linux
OS_RELEASE=2.6.32-5-686-bigmem
OS_TEST=i686
